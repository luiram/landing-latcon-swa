...
Código: [`src/features/booking/BookingWizard.tsx`](../src/features/booking/BookingWizard.tsx), patrón de cupos en [`bookingSlotDisplay.ts`](../src/features/booking/bookingSlotDisplay.ts).
