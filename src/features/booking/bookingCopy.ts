...
const copy: Record<LocaleCode, BookingCopy> = {
  es: {
    ...
    sectorOptions: [
      { value: "Agricultura y agronegocios", label: "Agricultura y agronegocios" },
  ...
  en: {
    ...
    sectorOptions: [
      { value: "Agricultura y agronegocios", label: "Agriculture & agribusiness" },
      { value: "Banca de inversión", label: "Investment banking" },
      { value: "Defensa", label: "Defense" },
      { value: "Educación", label: "Education" },
      { value: "Energía", label: "Energy" },
      { value: "Manufactura", label: "Manufacturing" },
      { value: "Oil & Gas", label: "Oil & Gas" },
      { value: "Salud", label: "Healthcare" },
      { value: "Seguros", label: "Insurance" },
      { value: "Servicios profesionales", label: "Professional services" },
      { value: "Transporte y logística", label: "Transportation & logistics" },
  ...
  pt: {
    ...
    sectorOptions: [
      { value: "Agricultura y agronegocios", label: "Agricultura e agronegócio" },
      { value: "Banca de inversión", label: "Banco de investimento" },
      { value: "Defensa", label: "Defesa" },
      { value: "Educación", label: "Educação" },
      { value: "Energía", label: "Energia" },
      { value: "Manufactura", label: "Manufatura" },
      { value: "Oil & Gas", label: "Oil & Gas" },
      { value: "Salud", label: "Saúde" },
      { value: "Seguros", label: "Seguros" },
      { value: "Servicios profesionales", label: "Serviços profissionais" },
      { value: "Transporte y logística", label: "Transporte e logística" },
  ...
  fr: {
    ...
    sectorOptions: [
      { value: "Agricultura y agronegocios", label: "Agriculture et agroalimentaire" },
      { value: "Banca de inversión", label: "Banque d’investissement" },
      { value: "Defensa", label: "Défense" },
      { value: "Educación", label: "Éducation" },
      { value: "Energía", label: "Énergie" },
      { value: "Manufactura", label: "Industrie manufacturière" },
      { value: "Oil & Gas", label: "Oil & Gas" },
      { value: "Salud", label: "Santé" },
      { value: "Seguros", label: "Assurance" },
      { value: "Servicios profesionales", label: "Services professionnels" },
      { value: "Transporte y logística", label: "Transport et logistique" },
